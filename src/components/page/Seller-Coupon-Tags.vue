            ...
            <el-table :data="tableData" border class="table" >
                ...
                <el-table-column  label="图标" >
                     <template   slot-scope="scope">            
                         <img :src="scope.row.tagIcon"  min-width="70" height="70" />
                    </template>  
                </el-table-column>
                ...
                <el-form-item label="标签名称">
                 ...
                 <el-form-item label="文件">
                     <el-upload
                        ...
                        :data="{'group':'seller-coupon-tags'}"
                        :accept="_cfg.upload.accept"
                        :on-success = 'handleSuccessFile'
                        :before-upload="handleBeforeFile" >
                        <img v-if="form.tagIcon" :src="form.tagIcon" class="avatar">
...
<script>
    export default {
        name: 'sellerCouponTags',
        data() {
            return {
                url:{
                    data: '/manager/seller/coupon/tags',
                    create:'/manager/seller/coupon/tags/create',
                    update:'/manager/seller/coupon/tags/update',
                    remove:'/manager/seller/coupon/tags/remove'
                },
                ctrl:{
                    editVisible: false,
                    new:false,
